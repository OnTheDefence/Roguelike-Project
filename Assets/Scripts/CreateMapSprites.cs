...
public class CreateMapSprites : MonoBehaviour
{
    public void Generate(GameObject current_node){
        ...
        Vector3 door_box_vector_size = new Vector3(0.9f, 0.9f, 0.9f);
        ...
        if (current_node.GetComponent<Node>().GetNorthExit() != null){
            ...
            north_door.GetComponent<BoxCollider2D>().size = door_box_vector_size;
            north_door.GetComponent<BoxCollider2D>().offset = new Vector3 ((float) 0,(float) 2.275, 1);
        ...
        if (current_node.GetComponent<Node>().GetEastExit() != null){
            ...
            east_door.GetComponent<BoxCollider2D>().size = door_box_vector_size;
            east_door.GetComponent<BoxCollider2D>().offset = new Vector3 ((float) 3.55,(float) 0, 1);
        ...
        if (current_node.GetComponent<Node>().GetSouthExit() != null){
            ...
            south_door.GetComponent<BoxCollider2D>().size = door_box_vector_size;
            south_door.GetComponent<BoxCollider2D>().offset = new Vector3 ((float) 0,(float) -2.275, 1);
        ...
        if (current_node.GetComponent<Node>().GetWestExit() != null){
            ...
            west_door.GetComponent<BoxCollider2D>().size = door_box_vector_size;
            west_door.GetComponent<BoxCollider2D>().offset = new Vector3 ((float) -3.55,(float) 0, 1);
